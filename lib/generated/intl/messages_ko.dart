...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m26(size) => "최대 파일 크기 : ${size} MB";

  static String m27(currency, amount) =>
      "이 결제를 사용하기 위한 최소 금액은 ${currency} ${amount}입니다.";

  static String m28(minute) => "${minute} 분 전";

  static String m29(month) => "${month} 개월 전";

  static String m30(store) => " ${store}에서 더보기";

  static String m31(number) => " ${number}그룹으로 구매해야 합니다.";

  static String m32(itemCount) => "${itemCount} 항목";

  static String m33(price) => "총 옵션 : ${price}";

  static String m34(amount) => " ${amount}지불";

  static String m35(name) => "${name} 이(가) 장바구니에 성공적으로 추가되었습니다";

  static String m36(total) => "수량: ${total}";

  static String m37(name) => " ${name}에서 돈을 받았습니다.";

  static String m38(percent) => "판매 ${percent} %";

  static String m39(keyword) => "검색 결과: \'${keyword}\'";

  static String m40(keyword, count) => "${keyword} (${count} 개 항목)";

  static String m41(keyword, count) => "${keyword} (${count} 개 항목)";

  static String m42(second) => "${second} 초 전";

  static String m43(totalCartQuantity) => "장바구니, ${totalCartQuantity} 개 항목";

  static String m44(numberOfUnitsSold) => "판매 : ${numberOfUnitsSold}";

  static String m45(fieldName) => " ${fieldName} 필드는 필수 항목입니다.";

  static String m46(total) => "${total} 제품";

  static String m47(name) => " ${name}로 송금";

  static String m48(maxPointDiscount, maxPriceDiscount) =>
      "이 주문에 ${maxPriceDiscount} 할인을 위해 최대 ${maxPointDiscount} 포인트를 사용하세요!";

  static String m49(date) => " ${date}까지 유효";

  static String m50(balance) => "지갑 잔액: ${balance}";

  static String m51(message) => "경고 : ${message}";

  static String m52(defaultCurrency) =>
      "현재 선택한 통화는 지갑 기능에 사용할 수 없습니다. ${defaultCurrency}(으)로 변경하십시오.";

  static String m53(length) => " ${length} 개의 제품을 찾았습니다.";

  static String m54(week) => "주 ${week}";

  static String m55(name) => "환영합니다 ${name}";

  static String m56(year) => "${year} 년 전";

  static String m57(total) => "주문 번호${total}에 할당했습니다.";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "clearCartAndAddNew":
            MessageLookupByLibrary.simpleMessage("장바구니 비우기 및 새로 추가"),
        ...
        "multipleSellersDetected":
            MessageLookupByLibrary.simpleMessage("여러 판매자가 감지됨"),
        "multipleSellersDetectedAndDisableMultiVendorCheckoutContent":
            MessageLookupByLibrary.simpleMessage(
                "새로운 판매자의 상품을 장바구니에 추가하려고 합니다. 한 번에 한 판매자에게서만 구매할 수 있다는 점에 유의하세요."),
        "multipleSellersDetectedAndEnableMultiVendorCheckoutContent":
            MessageLookupByLibrary.simpleMessage(
                "새로운 판매자의 제품을 장바구니에 추가하려고 합니다. 계속하시겠습니까?"),
