...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m6(number) => " Preostalo znakova:${number} ";

  static String m7(priceRate, pointRate) => "${priceRate} = ${pointRate} poena";

  static String m8(count) => "${count} stavka";

  static String m9(count) => "${count} stavki";

  static String m10(count) => "${count} stavka";

  static String m11(count) => "${count} stavki";

  static String m12(country) => "${country} zemlja nije podržana";

  static String m13(currency) => "${currency} nije podržan";

  static String m14(day) => "${day} dana prije";

  static String m15(total) => "~${total} km";

  static String m16(timeLeft) => "Završava za ${timeLeft}";

  static String m17(captcha) => "Unesite ${captcha} da potvrdite:";

  static String m18(message) => "Greška: ${message}";

  static String m19(message) => "Greška: ${message}";

  static String m20(time) => "Ističe za${time}";

  static String m21(total) => ">${total} km";

  static String m22(hour) => "${hour} sati prije";
  ...
  static String m26(size) => "Maksimalna veličina fajla: ${size} MB";

  static String m27(currency, amount) =>
      "Minimalni iznos za korištenje ove uplate je ${currency} ${amount}";

  static String m28(minute) => "${minute} minuta prije";

  static String m29(month) => "${month} mjeseca prije";

  static String m30(store) => "Više od ${store}";

  static String m31(number) => "mora se kupiti u grupama od ${number}";

  static String m32(itemCount) => "${itemCount} proizvoda";

  static String m33(price) => "Ukupno opcija: ${price}";

  static String m34(amount) => "Plati ${amount}";

  static String m35(name) => "${name} su uspješno dodani u korpu";

  static String m36(total) => "Količina: ${total}";

  static String m37(name) => "Primljen novac od ${name}";

  static String m38(percent) => "Rasprodaja ${percent}%";

  static String m39(keyword) => "Rezultati pretrage za: \'${keyword}\'";

  static String m40(keyword, count) => "${keyword} (${count} stavka)";

  static String m41(keyword, count) => "${keyword} (${count} stavki)";

  static String m42(second) => "${second} sekundi prije";

  static String m43(totalCartQuantity) =>
      "Korpa za kupovinu, ${totalCartQuantity} proizvoda";

  static String m44(numberOfUnitsSold) => "Prodano: ${numberOfUnitsSold}";

  static String m45(fieldName) => "Polje ${fieldName} je obavezno";

  static String m46(total) => "${total} proizvoda";

  static String m47(name) => "Prenesite novac na ${name}";
  ...
  static String m49(date) => "Validno do ${date}";

  static String m50(balance) => "Stanje novčanika: ${balance}";

  static String m51(message) => "Upozorenje: ${message}";
  ...
  static String m53(length) => "Pronašli smo ${length} proizvoda";

  static String m54(week) => "Sedmica ${week}";

  static String m55(name) => "Dobro došli ${name}";

  static String m56(year) => "${year} godine prije";

  static String m57(total) => "Dodijeljeni ste narudžbi #${total}";
