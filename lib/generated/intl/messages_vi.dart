...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m4(author) => "Tác giả: ${author}";

  static String m5(currency) => "Đã thay đổi đơn vị tiền tệ thành ${currency}";

  static String m6(number) => "${number} ký tự còn lại";

  static String m7(priceRate, pointRate) => "${priceRate} = ${pointRate} Điểm";

  static String m8(count) => " ${count} mục";

  static String m9(count) => "${count} mục";

  static String m10(count) => "${count} sản phẩm";

  static String m11(count) => "${count} sản phẩm";

  static String m12(country) => "${country} quốc gia không được hỗ trợ";

  static String m13(currency) => "${currency} không được hỗ trợ";

  static String m14(day) => "${day} ngày trước";

  static String m15(total) => "~${total} km";

  static String m16(timeLeft) => "Kết thúc sau ${timeLeft}";

  static String m17(captcha) => "Nhập ${captcha} để xác nhận:";

  static String m18(message) => "Lỗi: ${message}";

  static String m19(message) => "Lỗi: ${message}";

  static String m20(time) => "Hết hạn sau ${time}";

  static String m21(total) => ">${total} km";

  static String m22(hour) => "${hour} giờ trước";
  ...
  static String m26(size) => "Kích thước tệp tối đa: ${size} MB";

  static String m27(currency, amount) =>
      "Số tiền tối thiểu để sử dụng khoản thanh toán này là ${currency} ${amount}";

  static String m28(minute) => "${minute} phút trước";

  static String m29(month) => "${month} tháng trước";

  static String m30(store) => "Thêm từ ${store}";

  static String m31(number) => "phải mua theo nhóm ${number}";

  static String m32(itemCount) => "${itemCount} mặt hàng";

  static String m33(price) => "Tổng số tùy chọn: ${price}";

  static String m34(amount) => "Thanh toán ${amount}";

  static String m35(name) => "${name} đã được thêm vào giỏ hàng thành công";

  static String m36(total) => "Số lượng: ${total}";

  static String m37(name) => "Nhận tiền từ ${name}";

  static String m38(percent) => "Sale ${percent} %";

  static String m39(keyword) => "Kết quả tìm kiếm cho: \'${keyword}\'";

  static String m40(keyword, count) => "${keyword} (${count} mục)";

  static String m41(keyword, count) => "${keyword} (${count} mục)";

  static String m42(second) => "${second} giây trước";

  static String m43(totalCartQuantity) =>
      "Giỏ hàng, ${totalCartQuantity} sản phẩm";

  static String m44(numberOfUnitsSold) => "Đã bán: ${numberOfUnitsSold}";

  static String m45(fieldName) => "Trường ${fieldName} là bắt buộc";

  static String m46(total) => "${total} sản phẩm";

  static String m47(name) => "Chuyển tiền đến ${name}";
  ...
  static String m49(date) => "Có hiệu lực cho đến ${date}";

  static String m50(balance) => "Số dư trên ví: ${balance}";

  static String m51(message) => "Cảnh báo: ${message}";
  ...
  static String m53(length) => "Chúng tôi tìm thấy ${length} sản phẩm";

  static String m54(week) => "Tuần ${week}";

  static String m55(name) => "Chào mừng ${name}";

  static String m56(year) => "${year} năm trước";

  static String m57(total) => "Bạn đã chỉ định đơn đặt hàng số${total}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "cancelOrder": MessageLookupByLibrary.simpleMessage("Đã huỷ đơn"),
        ...
        "clearCartAndAddNew":
            MessageLookupByLibrary.simpleMessage("Xóa giỏ hàng và thêm mới"),
        "clearConversation":
        ...
        "emptySearch": MessageLookupByLibrary.simpleMessage(
            "Chưa có sản phẩm nào được tìm kiếm. Hãy bắt đầu ngay bây giờ - chúng tôi sẽ giúp bạn."),
        ...
        "enterYourUsername":
            MessageLookupByLibrary.simpleMessage("Nhập tên người dùng của bạn"),
        "error": m18,
        ...
        "forThisProduct": MessageLookupByLibrary.simpleMessage("sản phẩm này"),
        ...
        "readyToPick": MessageLookupByLibrary.simpleMessage("Chờ lấy hàng"),
        ...
        "registerErrorSyncAccount": MessageLookupByLibrary.simpleMessage(
            "Chưa thể đồng bộ tài khoản. Vui lòng đăng nhập để tiếp tục."),
        "registerFailed":
        ...
        "transactionFailded":
            MessageLookupByLibrary.simpleMessage("Giao dịch không thành công"),
        "transactionFailed":
