...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m26(size) => "Tiedoston enimmäiskoko: ${size} Mt";

  static String m27(currency, amount) =>
      "Tämän maksun vähimmäissumma on ${currency} ${amount}";

  static String m28(minute) => "${minute} minuuttia sitten";

  static String m29(month) => "${month} kuukautta sitten";

  static String m30(store) => "Lisää käyttäjältä ${store}";

  static String m31(number) => "täytyy ostaa ryhmissä ${number}";

  static String m32(itemCount) => "${itemCount} kohdetta";

  static String m33(price) => "Vaihtoehdot yhteensä: ${price}";

  static String m34(amount) => "Maksa ${amount}";

  static String m35(name) => "${name} on lisätty ostoskoriin onnistuneesti";

  static String m36(total) => "Määrä: ${total}";

  static String m37(name) => "Vastaanotettu rahaa käyttäjältä ${name}";

  static String m38(percent) => "Alennus ${percent}%";

  static String m39(keyword) => "Hakutulokset: \'${keyword}\'";

  static String m40(keyword, count) => "${keyword} (${count} kohde)";

  static String m41(keyword, count) => "${keyword} (${count} kohdetta)";

  static String m42(second) => "${second} sekuntia sitten";

  static String m43(totalCartQuantity) =>
      "Ostoskori, ${totalCartQuantity} tuotetta";

  static String m44(numberOfUnitsSold) => "Myyty: ${numberOfUnitsSold}";

  static String m45(fieldName) => "Kenttä ${fieldName} on pakollinen";

  static String m46(total) => "${total} tuotetta";

  static String m47(name) => "Siirrä rahaa käyttäjälle ${name}";
  ...
  static String m49(date) => "Voimassa ${date}asti";

  static String m50(balance) => "Wallet-saldo: ${balance}";

  static String m51(message) => "Varoitus: ${message}";
  ...
  static String m53(length) => "Löysimme ${length} tuotetta";

  static String m54(week) => "Viikko ${week}";

  static String m55(name) => "Tervetuloa ${name}";

  static String m56(year) => "${year} vuotta sitten";

  static String m57(total) => "Olet määrittänyt tilauksen #${total}";
