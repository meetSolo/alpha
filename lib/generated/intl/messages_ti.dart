...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m14(day) => "${day} ቅድሚ ሒደት መዓልትታት";

  static String m15(total) => "~${total} ኪሎሜተር";

  static String m16(timeLeft) => " እብ ${timeLeft} ውሽጢ ከብቅዕ\'ዩ";

  static String m17(captcha) => "ነዚ ንምርግጋጽ ናብ ${captcha} ኣተዉ፦";

  static String m18(message) => "ጌጋ ፦ ${message}";

  static String m20(time) => "ኣብ ${time} ግዜ ክወድቅ\'ዩ";

  static String m21(total) => ">${total} ኪሎሜተር";

  static String m22(hour) => "${hour} ቅድሚ ሰዓታት";

  static String m24(message) =>
      "ነቲ ሓበሬታ ኽትሓትት ከላ ምስታ ኣፕሊኬሽን እተተሓሓዘ ጕዳይ ኣሎ በጃኻ ነቲ ጕዳያት ንምፍታሕ ምስ ኣመሓዳሪ ተራኸብ - ${message}";

  static String m26(size) => "ዝለዓለ መጠን ፋይል: ${size} MB";

  static String m28(minute) => "${minute} ቅድሚ ሒደት ደቓይቕ";

  static String m29(month) => "${month} ቅድሚ ኣዋርሕ";

  static String m32(itemCount) => "${itemCount} ኣቕሑት";

  static String m33(price) => "ድምር ኣማራጺታት: ${price}";

  static String m36(total) => "ብዝሒ ፦ ${total}";

  static String m38(percent) => "መሸጣ ${percent}%";

  static String m42(second) => "${second} ቅድሚ ኻልኢታት";

  static String m43(totalCartQuantity) =>
      "ዓረብያ ዕድጊ ${totalCartQuantity} ንብረት/ታት";

  static String m44(numberOfUnitsSold) => "እተሸጠ፦ ${numberOfUnitsSold}";

  static String m46(total) => "${total}  ፍርያት";

  static String m49(date) => "ቅቡል ክሳብ ${date}";

  static String m51(message) => "መጠንቀቕታ ፦ ${message}";

  static String m52(defaultCurrency) =>
      "እቲ ኣብዚ እዋን እዚ እተመርጸ ባጤራ ነቲ ኣብ ቦርሳ ዘሎ ኣቕሓ ኣይርከብን እዩ:: በጃኻ ናብ ${defaultCurrency} ለወጥዎ";

  static String m53(length) => "ፍርያት ${length} ረኸብና";

  static String m54(week) => "ሰሙን ${week}";

  static String m56(year) => "${year} ቅድሚ ዓመታት";

  static String m57(total) => "ትእዛዝ ክትእዝዝ መዲብካ ኣለኻ #${total}";
