...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m5(currency) => "Ændrede valuta til ${currency}";

  static String m6(number) => "${number} tegn tilbage";

  static String m7(priceRate, pointRate) => "${priceRate} = ${pointRate} point";

  static String m8(count) => "${count} element";

  static String m9(count) => "${count} elementer";

  static String m10(count) => "${count} element";

  static String m11(count) => "${count} elementer";

  static String m12(country) => "${country} land understøttes ikke";

  static String m13(currency) => "${currency} understøttes ikke";

  static String m14(day) => "${day} dage siden";

  static String m15(total) => "~${total} km";

  static String m16(timeLeft) => "Slutter om ${timeLeft}";

  static String m17(captcha) => "Indtast ${captcha} for at bekræfte:";

  static String m18(message) => "Fejl: ${message}";

  static String m19(message) => "Fejl: ${message}";

  static String m20(time) => "Udløber om ${time}";

  static String m21(total) => ">${total} km";

  static String m22(hour) => " for${hour} timer siden";
  ...
  static String m28(minute) => " for${minute} minutter siden";

  static String m29(month) => " for${month} måneder siden";

  static String m30(store) => "Mere fra ${store}";

  static String m31(number) => "skal købes i grupper af ${number}";

  static String m32(itemCount) => "${itemCount} elementer";

  static String m33(price) => "Indstillinger i alt: ${price}";

  static String m34(amount) => "Betal ${amount}";

  static String m35(name) => "${name} er blevet tilføjet til indkøbskurven";

  static String m36(total) => "Antal: ${total}";

  static String m37(name) => "Modtog penge fra ${name}";

  static String m38(percent) => "Udsalg ${percent}%";

  static String m39(keyword) => "Søgeresultater for: \'${keyword}\'";

  static String m40(keyword, count) => "${keyword} (${count} element)";

  static String m41(keyword, count) => "${keyword} (${count} elementer)";

  static String m42(second) => " for${second} sekunder siden";
  ...
  static String m45(fieldName) => "Feltet ${fieldName} er påkrævet";

  static String m46(total) => "${total} produkter";

  static String m47(name) => "Overfør penge til ${name}";
  ...
  static String m53(length) => "Vi fandt ${length} produkter";

  static String m54(week) => "Uge ${week}";

  static String m55(name) => "Velkommen ${name}";

  static String m56(year) => " for${year} år siden";

  static String m57(total) => "Du har tildelt ordrenummer${total}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "byAuthor": m4,
        "byBrand": MessageLookupByLibrary.simpleMessage("Af Brand"),
        ...
        "cancelOrder": MessageLookupByLibrary.simpleMessage("Afbestille"),
        "cancelled": MessageLookupByLibrary.simpleMessage("Aflyst"),
        "cancelledRequests":
        ...
        "clearCartAndAddNew":
            MessageLookupByLibrary.simpleMessage("Ryd kurv og tilføj ny"),
        "clearConversation":
        ...
        "emailAddressInvalid":
            MessageLookupByLibrary.simpleMessage("E-mail-adressen er ugyldig"),
        "emailAlreadyInUse":
            MessageLookupByLibrary.simpleMessage("E-mail er allerede i brug!"),
        ...
        "loginToReview": MessageLookupByLibrary.simpleMessage(
            "Log venligst ind for at gennemgå"),
        "loginToYourAccount":
        ...
        "mobileIsRequired":
            MessageLookupByLibrary.simpleMessage("Mobil er påkrævet"),
        "mobileNumberInUse": MessageLookupByLibrary.simpleMessage(
            "Mobilnummer er allerede i brug!"),
        "mobileVerification":
        ...
        "multipleSellersDetectedAndDisableMultiVendorCheckoutContent":
            MessageLookupByLibrary.simpleMessage(
                "Du forsøger at tilføje et produkt fra en ny sælger til din indkøbskurv. Bemærk, at du kun kan købe hos én sælger ad gangen."),
        ...
        "processing": MessageLookupByLibrary.simpleMessage("Forarbejdning..."),
        ...
        "sendTo": MessageLookupByLibrary.simpleMessage(
            "Den konto du vil overføre til (e-mail)"),
        ...
        "subTitleOrderConfirmed": MessageLookupByLibrary.simpleMessage(
            "Tak for din ordre. Vi arbejder hurtigt på at behandle din ordre. Hold øje med en bekræftelsesmail inden længe"),
        ...
        "website": MessageLookupByLibrary.simpleMessage("Internet side"),
        ...
        "willNotSendAndReceiveMessage": MessageLookupByLibrary.simpleMessage(
            "Du vil ikke være i stand til at sende og modtage beskeder fra denne bruger."),
        "withdrawAmount": MessageLookupByLibrary.simpleMessage("Hæve beløb"),
        "withdrawRequest":
            MessageLookupByLibrary.simpleMessage("Træk anmodning tilbage"),
        "withdrawal": MessageLookupByLibrary.simpleMessage("Tilbagetrækning"),
        "womanCollections":
        ...
        "youDontHavePermissionToCreatePost":
            MessageLookupByLibrary.simpleMessage(
                "Du har ikke tilladelse til at oprette indlæg"),
        "youHaveAssignedToOrder": m57,
        "youHaveBeenSaveAddressYourLocal": MessageLookupByLibrary.simpleMessage(
            "Du har gemt adresse i dit lokale"),
        "youHaveNoPost":
            MessageLookupByLibrary.simpleMessage("Du har ingen indlæg"),
        "youHavePoints":
