...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m14(day) => "${day} ڕۆژ پێش ئێستا";

  static String m16(timeLeft) => "${timeLeft} تەواو دەبێت";

  static String m18(message) => "هەڵە: ${message}";

  static String m20(time) => "بەسەردەچێت لە ${time}";

  static String m22(hour) => "${hour} کاتژمێر پێش ئێستا";
  ...
  static String m28(minute) => "${minute} خولەك پێش ئێستا";

  static String m32(itemCount) => "${itemCount} ئایتم";

  static String m33(price) => "کۆى گشتى هەڵبژاردنەکان: ${price}";

  static String m38(percent) => "داشکاندن ${percent} %";

  static String m42(second) => "${second} چرکە پێش ئێستا";
  ...
  static String m46(total) => "${total} بەرهەمەکان";

  static String m49(date) => "گونجاوە تا ${date}";

  static String m51(message) => "ئاگاداری: ${message}";

  static String m53(length) => "${length} بەرهەم دۆزرایەوە";
