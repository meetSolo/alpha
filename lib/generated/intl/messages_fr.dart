...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m5(currency) => "Devise changée en ${currency}";

  static String m6(number) => " ${number} caractères restants";
  ...
  static String m9(count) => " ${count} éléments";

  static String m10(count) => "${count} article";

  static String m11(count) => "${count}  Articles";

  static String m12(country) => "${country}  pays n\'est pas pris en charge";

  static String m13(currency) => " ${currency} n\'est pas pris en charge";

  static String m14(day) => "Il y a ${day} jours";

  static String m15(total) => "~${total} km";

  static String m16(timeLeft) => "Termine en ${timeLeft}";

  static String m17(captcha) => "Saisissez ${captcha} pour confirmer :";

  static String m18(message) => "Erreur: ${message}";

  static String m19(message) => "Erreur :  ${message}";

  static String m20(time) => "Expire dans ${time}";

  static String m21(total) => ">${total} km";

  static String m22(hour) => "Il y a ${hour} heures";
  ...
  static String m26(size) => "Taille maximale du fichier: ${size} Mo";

  static String m27(currency, amount) =>
      "Le montant minimum pour utiliser ce paiement est de ${currency} ${amount}";

  static String m28(minute) => "Il y a ${minute} minutes";

  static String m29(month) => "Il y a ${month} mois";

  static String m30(store) => "Plus de ${store}";

  static String m31(number) => "doit être acheté par groupes de ${number}";

  static String m32(itemCount) => "${itemCount} produits";

  static String m33(price) => "Total des options: ${price}";

  static String m34(amount) => "Payer ${amount}";

  static String m35(name) => "${name} ont été ajoutés au panier avec succès";

  static String m36(total) => "Qté: ${total}";

  static String m37(name) => "J\'ai reçu de l\'argent de ${name}";

  static String m38(percent) => "Remise ${percent} %";

  static String m39(keyword) => "Résultats de recherche pour : \'${keyword}\'";

  static String m40(keyword, count) => "${keyword} (${count}  élément)";

  static String m41(keyword, count) => "${keyword} (${count}  éléments)";

  static String m42(second) => "Il y a ${second} secondes";

  static String m43(totalCartQuantity) =>
      "Panier, ${totalCartQuantity} produits";

  static String m44(numberOfUnitsSold) => "Vendus: ${numberOfUnitsSold}";

  static String m45(fieldName) => "Le champ ${fieldName} est obligatoire";

  static String m46(total) => "${total} Produits";

  static String m47(name) => "Transférer de l\'argent à ${name}";
  ...
  static String m50(balance) => "Solde du portefeuille : ${balance}";

  static String m51(message) => "Notice: ${message}";
  ...
  static String m53(length) => "Nous avons trouvé ${length} produits";

  static String m54(week) => "Semaine ${week}";

  static String m55(name) => "Bienvenue ${name}";

  static String m56(year) => "Il y a ${year} ans";

  static String m57(total) => "Vous etes affecté à la commande n°${total}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "accountApprovalTitle":
            MessageLookupByLibrary.simpleMessage("En cours d\'approbation"),
        ...
        "clearCartAndAddNew": MessageLookupByLibrary.simpleMessage(
            "Vider le panier et ajouter un nouveau"),
        "clearConversation":
        ...
        "countryCodeIsRequired":
            MessageLookupByLibrary.simpleMessage("Le code du pays est requis"),
        ...
        "delivering": MessageLookupByLibrary.simpleMessage("Livraison"),
        ...
        "enterAmount":
            MessageLookupByLibrary.simpleMessage("Entrer le montant"),
        "enterCaptcha": m17,
        ...
        "installDigitsPlugin": MessageLookupByLibrary.simpleMessage(
            "Veuillez installer le plugin DIGITS : inscription et connexion au numéro de téléphone mobile Wordpress"),
        "instantlyClose":
        ...
        "mobileIsRequired":
            MessageLookupByLibrary.simpleMessage("Le mobile est requis"),
        "mobileNumberInUse": MessageLookupByLibrary.simpleMessage(
            "Numéro de portable déjà utilisé !"),
        "mobileVerification":
        ...
        "multipleSellersDetectedAndEnableMultiVendorCheckoutContent":
            MessageLookupByLibrary.simpleMessage(
                "Vous essayez d\'ajouter un produit d\'un nouveau vendeur à votre panier. Voulez-vous continuer ?"),
        ...
        "noComments": MessageLookupByLibrary.simpleMessage("Sans commentaires"),
        "noConversation":
            MessageLookupByLibrary.simpleMessage("Pas encore de conversation"),
        "noConversationDescription": MessageLookupByLibrary.simpleMessage(
            "Il apparaîtra lorsque quelqu\'un commencera à discuter avec vous"),
        ...
        "picking":
            MessageLookupByLibrary.simpleMessage("En attente de livraison"),
        ...
        "sendTo": MessageLookupByLibrary.simpleMessage(
            "Le compte vers lequel vous souhaitez effectuer le transfert (e-mail)"),
        ...
        "shippingFee":
            MessageLookupByLibrary.simpleMessage("Frais d\'expédition"),
        "shippingMethod":
        ...
        "willNotSendAndReceiveMessage": MessageLookupByLibrary.simpleMessage(
            "Vous ne pourrez pas envoyer ni recevoir de messages de cet utilisateur."),
        "withdrawAmount":
