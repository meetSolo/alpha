...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m26(size) => "Максимальний розмір файлу: ${size} МБ";

  static String m27(currency, amount) =>
      "Мінімальна сума для використання цього платежу становить ${currency} ${amount}";

  static String m28(minute) => "${minute} хвилин тому";

  static String m29(month) => "${month} місяців тому";

  static String m30(store) => "Більше від ${store}";

  static String m31(number) => "потрібно купувати групами по ${number}";

  static String m32(itemCount) => "${itemCount} елементів";

  static String m33(price) => "Всього варіантів: ${price}";

  static String m34(amount) => "Сплатити ${amount}";

  static String m35(name) => "${name} успішно додано до кошика";

  static String m36(total) => "Кількість: ${total}";

  static String m37(name) => "Отримано гроші від ${name}";

  static String m38(percent) => "Продаж ${percent}%";

  static String m39(keyword) => "Результати пошуку для: \"${keyword}\"";

  static String m40(keyword, count) => "${keyword} (${count} елемент)";

  static String m41(keyword, count) => "${keyword} (${count} елементів)";

  static String m42(second) => "${second} секунд тому";

  static String m43(totalCartQuantity) =>
      "Кошик, товарів: ${totalCartQuantity} ";

  static String m44(numberOfUnitsSold) => "Продано: ${numberOfUnitsSold}";

  static String m45(fieldName) => "Поле ${fieldName} є обов’язковим";

  static String m46(total) => "${total} продуктів";

  static String m47(name) => "Переказ грошей на ${name}";
  ...
  static String m49(date) => "Діє до ${date}";

  static String m50(balance) => "Баланс гаманця: ${balance}";

  static String m51(message) => "Попередження: ${message}";

  static String m52(defaultCurrency) =>
      "Вибрана валюта зараз недоступна для функції Wallet. Змініть її на ${defaultCurrency}";

  static String m53(length) => "Ми знайшли ${length} продуктів";

  static String m54(week) => "Тиждень ${week}";

  static String m55(name) => "Ласкаво просимо ${name}";

  static String m56(year) => "${year} років тому";

  static String m57(total) => "Ви призначили замовлення №${total}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "multipleSellersDetectedAndDisableMultiVendorCheckoutContent":
            MessageLookupByLibrary.simpleMessage(
                "Ви намагаєтеся додати продукт від нового продавця до свого кошика. Зверніть увагу, що ви можете купувати лише в одного продавця одночасно."),
        "multipleSellersDetectedAndEnableMultiVendorCheckoutContent":
            MessageLookupByLibrary.simpleMessage(
                "Ви намагаєтеся додати продукт від нового продавця до свого кошика. Ви хочете продовжити?"),
