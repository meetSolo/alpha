...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m5(currency) => "Moneda cambiada a ${currency}";

  static String m6(number) => "${number} caracteres restantes";

  static String m7(priceRate, pointRate) =>
      "${priceRate} = ${pointRate} puntos";

  static String m8(count) => "${count} Artículo";

  static String m9(count) => "${count} Artículos";

  static String m10(count) => "${count} Artículo";

  static String m11(count) => "${count} artículos";

  static String m12(country) => "${country} país no esta disponible";

  static String m13(currency) => " ${currency} no esta disponible";

  static String m14(day) => "Hace ${day} días";

  static String m15(total) => "~${total} km";

  static String m16(timeLeft) => "Termina en ${timeLeft}";

  static String m17(captcha) => "Introduzca ${captcha} para confirmar:";

  static String m18(message) => "Error: ${message}";

  static String m19(message) => "Error: ${message}";

  static String m20(time) => "Expira en ${time}";

  static String m21(total) => ">${total} km";

  static String m22(hour) => "Hace ${hour} horas";
  ...
  static String m26(size) => "Tamaño máximo de archivo: ${size} MB";

  static String m27(currency, amount) =>
      "La cantidad mínima para usar este pago es ${currency} ${amount}";

  static String m28(minute) => "Hace ${minute} minutos";

  static String m29(month) => " Hace ${month} meses";

  static String m30(store) => "Más de ${store}";

  static String m31(number) => "debe comprarse en grupos de ${number}";

  static String m32(itemCount) => "${itemCount} items";

  static String m33(price) => "Total de opciones: ${price}";

  static String m34(amount) => "Pagar ${amount}";

  static String m35(name) => "${name} agregado al carrito";

  static String m36(total) => "Cantidad: ${total}";

  static String m37(name) => "Recibí dinero de ${name}";

  static String m38(percent) => "Rebaja ${percent} %";

  static String m39(keyword) => "Resultados de búsqueda para: \'${keyword}\'";

  static String m40(keyword, count) => "${keyword} (${count} elemento)";

  static String m41(keyword, count) => "${keyword} (${count} elementos)";

  static String m42(second) => "Hace ${second} segundos";

  static String m43(totalCartQuantity) =>
      "Carrito, ${totalCartQuantity} artículos";

  static String m44(numberOfUnitsSold) => "Vendido: ${numberOfUnitsSold}";

  static String m45(fieldName) => "El campo ${fieldName} es obligatorio";

  static String m46(total) => "${total} Productos";

  static String m47(name) => "Transferir dinero a ${name}";
  ...
  static String m49(date) => "Válido hasta ${date}";

  static String m50(balance) => "Saldo de la billetera: ${balance}";

  static String m51(message) => "Advertencia: ${message}";
  ...
  static String m53(length) => "Encontramos ${length} productos";

  static String m54(week) => "Semana ${week}";

  static String m55(name) => "Bienvenido ${name}";

  static String m56(year) => " Hace ${year} años";

  static String m57(total) => "Has asignado a la orden #${total}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "accountApprovalTitle":
            MessageLookupByLibrary.simpleMessage("Bajo aprobación"),
        ...
        "cannotDeleteAccount": MessageLookupByLibrary.simpleMessage(
            "Esta cuenta no se puede eliminar"),
        ...
        "clearCartAndAddNew": MessageLookupByLibrary.simpleMessage(
            "Limpiar carrito y agregar nuevo"),
        "clearConversation":
        ...
        "enterAmount": MessageLookupByLibrary.simpleMessage("Ingrese el monto"),
        "enterCaptcha": m17,
        ...
        "errorOnGettingPost": MessageLookupByLibrary.simpleMessage(
            "¡Error al recibir la publicación!"),
        ...
        "installDigitsPlugin": MessageLookupByLibrary.simpleMessage(
            "Instale el complemento DIGITS: Registro e inicio de sesión de número móvil de Wordpress"),
        "instantlyClose":
        ...
        "mobileIsRequired":
            MessageLookupByLibrary.simpleMessage("Se requiere móvil"),
        "mobileNumberInUse":
            MessageLookupByLibrary.simpleMessage("¡Número de móvil ya en uso!"),
        "mobileVerification":
        ...
        "multipleSellersDetectedAndDisableMultiVendorCheckoutContent":
            MessageLookupByLibrary.simpleMessage(
                "Estás intentando agregar un producto de un nuevo vendedor a tu carrito. Ten en cuenta que solo puedes comprarle a un vendedor a la vez."),
        "multipleSellersDetectedAndEnableMultiVendorCheckoutContent":
            MessageLookupByLibrary.simpleMessage(
                "Estás intentando añadir un producto de un nuevo vendedor a tu carrito. ¿Quieres continuar?"),
        ...
        "picking": MessageLookupByLibrary.simpleMessage("Esperando la entrega"),
        ...
        "readyToPick":
            MessageLookupByLibrary.simpleMessage("Esperando la entrega"),
        "receivedMoney":
        ...
        "registerErrorSyncAccount": MessageLookupByLibrary.simpleMessage(
            "No se puede sincronizar la cuenta. Inicie sesión para continuar."),
        "registerFailed":
            MessageLookupByLibrary.simpleMessage("Registro fallido"),
        "registerInvalid": MessageLookupByLibrary.simpleMessage(
            "La solicitud no es válida o ha expirado. Inténtelo de nuevo."),
        "registerSuccess":
        ...
        "sendTo": MessageLookupByLibrary.simpleMessage(
            "La cuenta a la que desea transferir (correo electrónico)"),
        ...
        "shippingFee": MessageLookupByLibrary.simpleMessage("Tarifa de envío"),
        "shippingMethod":
        ...
        "userNotFound":
            MessageLookupByLibrary.simpleMessage("No se encuentra el usuario"),
