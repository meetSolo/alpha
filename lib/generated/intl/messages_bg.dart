...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m5(currency) => "Променена валута на ${currency}";

  static String m6(number) => " Остават${number} знака";

  static String m7(priceRate, pointRate) => "${priceRate} = ${pointRate} точки";

  static String m8(count) => "${count} елемент";

  static String m9(count) => "${count} елемента";

  static String m10(count) => "${count} елемент";

  static String m11(count) => "${count} елемента";

  static String m12(country) => "Страната ${country} не се поддържа";

  static String m13(currency) => "${currency} не се поддържа";

  static String m14(day) => "${day} дни преди";

  static String m15(total) => "~${total} км";

  static String m16(timeLeft) => "Свършва след ${timeLeft}";

  static String m17(captcha) => "Въведете ${captcha}, за да потвърдите:";

  static String m18(message) => "Грешка: ${message}";

  static String m19(message) => "Грешка: ${message}";

  static String m20(time) => "Изтича след ${time}";

  static String m21(total) => ">${total} км";

  static String m22(hour) => "${hour} часа преди";
  ...
  static String m26(size) => "Максимален размер на файл: ${size} MB";

  static String m27(currency, amount) =>
      "Минималната сума за използване на този начин на плащане е ${currency} ${amount}";

  static String m28(minute) => "${minute} минути преди";

  static String m29(month) => "${month} месеца преди";

  static String m30(store) => "Още от ${store}";

  static String m31(number) => "трябва да се купува в групи от ${number}";

  static String m32(itemCount) => "${itemCount} артикула";

  static String m33(price) => "Обща стойност на опциите: ${price}";

  static String m34(amount) => "Платете ${amount}";

  static String m35(name) => "${name} са добавени успешно в количката";

  static String m36(total) => "Количество: ${total}";

  static String m37(name) => "Получени пари от ${name}";

  static String m38(percent) => "Разпродажба ${percent}%";

  static String m39(keyword) => "Резултати от търсенето на: „${keyword}“";

  static String m40(keyword, count) => "${keyword} (${count} елемент)";

  static String m41(keyword, count) => "${keyword} (${count} елемента)";

  static String m42(second) => "${second} секунди преди";

  static String m43(totalCartQuantity) =>
      "Количка за пазаруване, ${totalCartQuantity} артикула";

  static String m44(numberOfUnitsSold) => "Продадено: ${numberOfUnitsSold}";

  static String m45(fieldName) => "Полето ${fieldName} е задължително";

  static String m46(total) => "${total} продукта";

  static String m47(name) => "Прехвърлете пари на ${name}";
  ...
  static String m49(date) => "Валидно до ${date}";

  static String m50(balance) => "Салдо в Wallet: ${balance}";

  static String m51(message) => "Предупреждение: ${message}";
  ...
  static String m53(length) => "Намерихме ${length} продукта";

  static String m54(week) => "Седмица ${week}";

  static String m55(name) => "Добре дошъл, ${name}";

  static String m56(year) => "${year} години преди";

  static String m57(total) => "Вие сте назначени за поръчка №${total}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "addNewAddress":
            MessageLookupByLibrary.simpleMessage("Добавете нов адрес"),
        ...
        "addToCartSuccessfully":
            MessageLookupByLibrary.simpleMessage("Успешно добавен в количката"),
        "addToOrder":
        ...
        "bleState": m3,
        "block": MessageLookupByLibrary.simpleMessage("Блокирайте"),
        "blockUser":
        ...
        "branchChangeWarning": MessageLookupByLibrary.simpleMessage(
            "Съжаляваме, пазарската количка ще бъде изпразнена поради промяна на региона. Ще се радваме да се свържем с вас, ако имате нужда от помощ."),
        ...
        "cancelOrder": MessageLookupByLibrary.simpleMessage("Отказ"),
        ...
        "cannotDeleteAccount": MessageLookupByLibrary.simpleMessage(
            "Този акаунт не може да се изтрие"),
        "cannotSendMessage": MessageLookupByLibrary.simpleMessage(
            "Не можете да изпращате съобщения до този потребител"),
        ...
        "chooseBranch": MessageLookupByLibrary.simpleMessage("Изберете клона"),
        "chooseCategory":
        ...
        "confirmPasswordIsRequired": MessageLookupByLibrary.simpleMessage(
            "Полето за потвърждение на паролата е задължително"),
        ...
        "continueShopping":
            MessageLookupByLibrary.simpleMessage("Продължете да пазарувате"),
        "continueToPayment":
        ...
        "createReviewSuccess":
            MessageLookupByLibrary.simpleMessage("Благодаря ви за прегледа"),
        "createReviewSuccessMsg": MessageLookupByLibrary.simpleMessage(
            "Ние наистина оценяваме вашия принос и ценим вашия принос, за да ни помогнете да се подобрим"),
        "createVariants":
        ...
        "descriptionEnterVoucher": MessageLookupByLibrary.simpleMessage(
            "Моля, въведете или изберете ваучера за вашата поръчка."),
        "didntReceiveCode":
        ...
        "doYouWantToLeaveWithoutSubmit": MessageLookupByLibrary.simpleMessage(
            "Искате ли да напуснете, без да изпратите отзива си?"),
        "doYouWantToLogout":
        ...
        "emailAddressInvalid":
            MessageLookupByLibrary.simpleMessage("Имейл адресът е невалиден"),
        "emailAlreadyInUse":
            MessageLookupByLibrary.simpleMessage("Имейл вече се използва!"),
        ...
        "emptyBookingHistoryMsg": MessageLookupByLibrary.simpleMessage(
            "Изглежда, че все още не сте направили никакви резервации. \nЗапочнете да изследвате и направете първата си резервация!"),
        ...
        "emptyCartSubtitle02": MessageLookupByLibrary.simpleMessage(
            "Опа! Количката ви е малко лека. \n\nГотови ли сте да пазарувате нещо невероятно?"),
        ...
        "emptyWishlistSubtitle02": MessageLookupByLibrary.simpleMessage(
            "Вашият списък с желания в момента е празен.\nЗапочнете да добавяте продукти сега!"),
        "enableForCheckout":
        ...
        "enterVoucherCode":
            MessageLookupByLibrary.simpleMessage("Въведете кода на ваучера"),
        "enterYourEmail":
        ...
        "errorOnGettingPost": MessageLookupByLibrary.simpleMessage(
            "Грешка при получаване на публикация!"),
        ...
        "fair": MessageLookupByLibrary.simpleMessage("Справедлива"),
        ...
        "minutesAgo": m28,
        "mobile": MessageLookupByLibrary.simpleMessage("Подвижен"),
        "mobileIsRequired":
            MessageLookupByLibrary.simpleMessage("Изисква се мобилен телефон"),
        "mobileNumberInUse": MessageLookupByLibrary.simpleMessage(
            "Мобилният номер вече се използва!"),
        "mobileVerification":
        ...
        "multipleSellersDetected": MessageLookupByLibrary.simpleMessage(
            "Открити са множество продавачи"),
        "multipleSellersDetectedAndDisableMultiVendorCheckoutContent":
            MessageLookupByLibrary.simpleMessage(
                "Опитвате се да добавите продукт от нов продавач към вашата кошница. Моля, обърнете внимание, че можете да купувате само от един продавач наведнъж."),
        "multipleSellersDetectedAndEnableMultiVendorCheckoutContent":
            MessageLookupByLibrary.simpleMessage(
                "Опитвате се да добавите продукт от нов продавач към вашата кошница. Искате ли да продължите?"),
        ...
        "needHelp":
            MessageLookupByLibrary.simpleMessage("Нуждаете се от помощ?"),
        ...
        "noConversationDescription": MessageLookupByLibrary.simpleMessage(
            "Ще се появи, когато някой започне да чати с вас"),
        ...
        "noPaymentMethodsAvailable": MessageLookupByLibrary.simpleMessage(
            "Няма налични методи за плащане."),
        ...
        "noTransactionsMsg": MessageLookupByLibrary.simpleMessage(
            "Съжаляваме, няма намерени транзакции!"),
        ...
        "notRated": MessageLookupByLibrary.simpleMessage("Не е оценено"),
        ...
        "oneEachRecipient":
            MessageLookupByLibrary.simpleMessage("1 за всеки получател"),
        ...
        "optional": MessageLookupByLibrary.simpleMessage("Не е задължително"),
        ...
        "passwordIsRequired": MessageLookupByLibrary.simpleMessage(
            "Полето за парола е задължително"),
        "passwordsDoNotMatch":
        ...
        "paymentDetailsChangedSuccessfully":
            MessageLookupByLibrary.simpleMessage(
                "Детайлите за плащане са променени успешно."),
        "paymentMethod":
        ...
        "picking": MessageLookupByLibrary.simpleMessage("Чака доставка"),
        "placeMyOrder":
        ...
        "poor": MessageLookupByLibrary.simpleMessage("беден"),
        ...
        "preview":
            MessageLookupByLibrary.simpleMessage("предварителен преглед"),
        ...
        "productOutOfStock":
            MessageLookupByLibrary.simpleMessage("Този продукт е изчерпан"),
        "productOverview":
        ...
        "random": MessageLookupByLibrary.simpleMessage("Случаен"),
        ...
        "readyToPick": MessageLookupByLibrary.simpleMessage("Чака доставка"),
        ...
        "registerErrorSyncAccount": MessageLookupByLibrary.simpleMessage(
            "Не може да се синхронизира акаунт. Моля, влезте, за да продължите."),
        "registerFailed":
        ...
        "searchEmptyDataMessage": MessageLookupByLibrary.simpleMessage(
            "Опа! Изглежда, че няма резултати, отговарящи на вашите критерии за търсене"),
        "searchForItems":
        ...
        "sendTo": MessageLookupByLibrary.simpleMessage(
            "Акаунтът, към който искате да прехвърлите (имейл)"),
        ...
        "sizeGuide":
            MessageLookupByLibrary.simpleMessage("Ръководство за размери"),
        ...
        "storeLocatorSearchPlaceholder":
            MessageLookupByLibrary.simpleMessage("Въведете адрес/град"),
        ...
        "subTitleOrderConfirmed": MessageLookupByLibrary.simpleMessage(
            "Благодаря за вашата поръчка. Работим бързо, за да обработим вашата поръчка. Очаквайте скоро имейл за потвърждение"),
        ...
        "to": MessageLookupByLibrary.simpleMessage("да се"),
        ...
        "unblock": MessageLookupByLibrary.simpleMessage("Разблокирай"),
        "unblockUser":
            MessageLookupByLibrary.simpleMessage("Деблокиране на потребителя"),
        ...
        "viewCart": MessageLookupByLibrary.simpleMessage("Вижте количката"),
        "viewDetail": MessageLookupByLibrary.simpleMessage("Вижте подробности"),
        "viewMore": MessageLookupByLibrary.simpleMessage("Вижте повече"),
        "viewOnGoogleMaps":
            MessageLookupByLibrary.simpleMessage("Вижте в Google Maps"),
        "viewOrder": MessageLookupByLibrary.simpleMessage("Вижте поръчката"),
        ...
        "welcomeBack":
            MessageLookupByLibrary.simpleMessage("Добре дошъл отново"),
        "welcomeRegister": MessageLookupByLibrary.simpleMessage(
            "Започнете пазаруването си с нас сега"),
        "welcomeUser": m55,
        ...
        "withdrawAmount":
            MessageLookupByLibrary.simpleMessage("Теглене на сума"),
        "withdrawRequest":
            MessageLookupByLibrary.simpleMessage("Оттегляне на заявка"),
        "withdrawal": MessageLookupByLibrary.simpleMessage("Оттегляне"),
        "womanCollections":
        ...
        "youDontHavePermissionToCreatePost":
            MessageLookupByLibrary.simpleMessage(
                "Нямате разрешение за създаване на публикация"),
        ...
        "yourOrderIsEmptyMsg": MessageLookupByLibrary.simpleMessage(
            "Изглежда, че не сте добавили никакви елементи.\nЗапочнете да пазарувате, за да го попълните."),
