...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m4(author) => "Müəllif: ${author}";

  static String m5(currency) => "Valyuta ${currency}olaraq dəyişdirildi";

  static String m6(number) => "${number} simvol qalıb";

  static String m7(priceRate, pointRate) => "${priceRate} = ${pointRate} Xal";

  static String m8(count) => "${count} element";

  static String m9(count) => "${count} element";

  static String m10(count) => "${count} element";

  static String m11(count) => "${count} element";

  static String m12(country) => "${country} ölkə dəstəklənmir";

  static String m13(currency) => "${currency} dəstəklənmir";

  static String m14(day) => "${day} gün öncə";

  static String m15(total) => "~${total} km";

  static String m16(timeLeft) => " ${timeLeft}tarixində bitir";

  static String m17(captcha) => "Təsdiq etmək üçün ${captcha} daxil edin:";

  static String m18(message) => "Xəta: ${message}";

  static String m19(message) => "Xəta: ${message}";

  static String m20(time) => " ${time}tarixində başa çatır";

  static String m21(total) => ">${total} km";

  static String m22(hour) => "${hour} saat öncə";
  ...
  static String m26(size) => "Maksimum fayl ölçüsü: ${size} MB";

  static String m27(currency, amount) =>
      "Bu ödənişdən istifadə üçün minimum məbləğ: ${currency} ${amount}";

  static String m28(minute) => "${minute} dəqiqə öncə";

  static String m29(month) => "${month} ay əvvəl";

  static String m30(store) => " ${store}saytından daha çox";

  static String m31(number) => " ${number}qruplarında alınmalıdır";

  static String m32(itemCount) => "${itemCount} məhsul";

  static String m33(price) => "Cəmi seçimlər: ${price}";

  static String m34(amount) => " ${amount}ödəyin";

  static String m35(name) => "${name} səbətə uğurla əlavə edildi";

  static String m36(total) => "Miqdar: ${total}";

  static String m37(name) => " ${name}tərəfindən pul alındı ";

  static String m38(percent) => "Endirim ${percent}%";

  static String m39(keyword) => "Axtarış nəticələri: \'${keyword}\'";

  static String m40(keyword, count) => "${keyword} (${count} element)";

  static String m41(keyword, count) => "${keyword} (${count} element)";

  static String m42(second) => "${second} saniyə öncə";

  static String m43(totalCartQuantity) =>
      "Səbətdə ${totalCartQuantity} məhsul var";

  static String m44(numberOfUnitsSold) => "Satıldı: ${numberOfUnitsSold}";

  static String m45(fieldName) => " ${fieldName} sahəsi tələb olunur";

  static String m46(total) => "${total} məhsul";

  static String m47(name) => " ${name}hesabına pul köçürün ";
  ...
  static String m49(date) => " ${date}tarixinə qədər etibarlıdır";

  static String m50(balance) => "Pulqabı balansı: ${balance}";

  static String m51(message) => "Xəbərdarlıq: ${message}";
  ...
  static String m53(length) => "${length} məhsul tapıldı";

  static String m54(week) => "Həftə ${week}";

  static String m55(name) => "Xoş gəldiniz ${name}";

  static String m56(year) => "${year} il əvvəl";

  static String m57(total) => "Siz №${total}sifarişi təyin etdiniz";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "accountApprovalTitle":
            MessageLookupByLibrary.simpleMessage("Təsdiq altında"),
        ...
        "approvedRequests":
            MessageLookupByLibrary.simpleMessage("Təsdiqlənmiş Sorğular"),
        ...
        "availabilityProduct":
            MessageLookupByLibrary.simpleMessage("Mövcudluq: "),
        "availablePoints": m2,
        ...
        "blockUser":
            MessageLookupByLibrary.simpleMessage("İstifadəçini bloklayın"),
        ...
        "cancelOrder": MessageLookupByLibrary.simpleMessage("Ləğv et"),
        "cancelled": MessageLookupByLibrary.simpleMessage("Ləğv edildi"),
        "cancelledRequests":
            MessageLookupByLibrary.simpleMessage("Ləğv Edilmiş Sorğular"),
        ...
        "countryCodeIsRequired":
            MessageLookupByLibrary.simpleMessage("Ölkə kodu tələb olunur"),
        ...
        "deleteConversation":
            MessageLookupByLibrary.simpleMessage("Söhbəti silin"),
        ...
        "emailAddressInvalid":
            MessageLookupByLibrary.simpleMessage("E-poçt ünvanı yanlışdır"),
        ...
        "mobileIsRequired":
            MessageLookupByLibrary.simpleMessage("Mobil tələb olunur"),
        ...
        "multipleSellersDetected":
            MessageLookupByLibrary.simpleMessage("Çoxlu Satıcılar Aşkarlandı"),
        ...
        "noSuggestionSearch":
            MessageLookupByLibrary.simpleMessage("Heç bir təklif yoxdur"),
        ...
        "paymentSettings":
            MessageLookupByLibrary.simpleMessage("Ödəniş Parametrləri"),
        "paymentSuccessful":
        ...
        "picking": MessageLookupByLibrary.simpleMessage("Çatdırılma gözləyir"),
        "placeMyOrder":
        ...
        "readyToPick":
            MessageLookupByLibrary.simpleMessage("Çatdırılma gözləyir"),
        ...
        "registerErrorSyncAccount": MessageLookupByLibrary.simpleMessage(
            "Hesabı sinxronlaşdırmaq mümkün deyil. Davam etmək üçün daxil olun."),
        "registerFailed":
            MessageLookupByLibrary.simpleMessage("Qeydiyyat uğursuz oldu"),
        "registerInvalid": MessageLookupByLibrary.simpleMessage(
            "Sorğu etibarsızdır və ya vaxtı keçmişdir. Yenidən cəhd edin"),
        "registerSuccess":
        ...
        "searchEmptyDataMessage": MessageLookupByLibrary.simpleMessage(
            "Vay! Görünür, axtarış kriteriyalarınıza uyğun heç bir nəticə yoxdur"),
        ...
        "storeLocatorSearchPlaceholder":
            MessageLookupByLibrary.simpleMessage("Ünvan / şəhər daxil edin"),
        ...
        "subTitleOrderConfirmed": MessageLookupByLibrary.simpleMessage(
            "Sifarişiniz üçün təşəkkür edirik. Sifarişinizi emal etmək üçün sürətlə işləyirik. Tezliklə təsdiq e-poçtu üçün bizi izləyin"),
        ...
        "userHasBeenBlocked":
            MessageLookupByLibrary.simpleMessage("İstifadəçi bloklanıb"),
        ...
        "usernameInvalid":
            MessageLookupByLibrary.simpleMessage("İstifadəçi adı yanlışdır"),
        "usernameIsRequired":
            MessageLookupByLibrary.simpleMessage("İstifadəçi adı tələb olunur"),
        ...
        "withdrawAmount":
            MessageLookupByLibrary.simpleMessage("Məbləği çıxarın"),
        "withdrawRequest":
            MessageLookupByLibrary.simpleMessage("Sorğunu geri götür"),
        ...
        "youHaveNoPost":
            MessageLookupByLibrary.simpleMessage("Heç bir postunuz yoxdur"),
        "youHavePoints":
