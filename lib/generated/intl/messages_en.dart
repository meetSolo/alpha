...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m5(currency) => "Changed currency to ${currency}";

  static String m6(number) => "${number} characters remaining";
  ...
  static String m12(country) => "${country} country is not supported";

  static String m13(currency) => "${currency} is not supported";
  ...
  static String m17(captcha) => "Enter ${captcha} to confirm:";
  ...
  static String m26(size) => "Maximum file size: ${size} MB";
  ...
  static String m29(month) => "${month} months ago";

  static String m30(store) => "More from ${store}";

  static String m31(number) => "must be bought in groups of ${number}";

  static String m32(itemCount) => "${itemCount} items";

  static String m33(price) => "Options total: ${price}";

  static String m34(amount) => "Pay ${amount}";

  static String m35(name) => "${name} have been added to cart successfully";

  static String m36(total) => "Qty: ${total}";

  static String m37(name) => "Received money from ${name}";

  static String m38(percent) => "Sale ${percent}%";

  static String m39(keyword) => "Search results for: \'${keyword}\'";

  static String m40(keyword, count) => "${keyword} (${count} item)";

  static String m41(keyword, count) => "${keyword} (${count} items)";
  ...
  static String m45(fieldName) => "The ${fieldName} field is required";

  static String m46(total) => "${total} products";

  static String m47(name) => "Transfer money to ${name}";
  ...
  static String m50(balance) => "Wallet balance: ${balance}";
  ...
  static String m56(year) => "${year} years ago";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "cancelOrder": MessageLookupByLibrary.simpleMessage("Cancel"),
        ...
        "picking": MessageLookupByLibrary.simpleMessage("Waiting for delivery"),
