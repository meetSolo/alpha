...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m26(size) => "Maximální velikost souboru: ${size} MB";

  static String m27(currency, amount) =>
      "Minimální částka pro použití této platby je ${currency} ${amount}";

  static String m28(minute) => " Před${minute} minutami";

  static String m29(month) => " Před${month} měsíci";

  static String m30(store) => "Více od uživatele ${store}";

  static String m31(number) => "nutno zakoupit ve skupinách po ${number}";

  static String m32(itemCount) => " Položky:${itemCount} ";

  static String m33(price) => "Celkem možností: ${price}";

  static String m34(amount) => "Zaplatit ${amount}";

  static String m35(name) => "${name} byly úspěšně přidány do košíku";

  static String m36(total) => "Množství: ${total}";

  static String m37(name) => "Přijaté peníze od ${name}";

  static String m38(percent) => "Výprodej ${percent}%";

  static String m39(keyword) => "Výsledky hledání pro: \'${keyword}\'";

  static String m40(keyword, count) => "${keyword} (${count} položka)";

  static String m41(keyword, count) => "${keyword} (počet položek:${count} )";

  static String m42(second) => " Před${second} s";

  static String m43(totalCartQuantity) =>
      "Nákupní košík, položky: ${totalCartQuantity} ";

  static String m44(numberOfUnitsSold) => "Prodáno: ${numberOfUnitsSold}";

  static String m45(fieldName) => "Pole ${fieldName} je povinné";

  static String m46(total) => "${total} produktů";

  static String m47(name) => "Převést peníze na ${name}";
  ...
  static String m50(balance) => "Zůstatek v peněžence: ${balance}";

  static String m51(message) => "Upozornění: ${message}";
  ...
  static String m53(length) => "Našli jsme ${length} produktů";

  static String m54(week) => "Týden ${week}";

  static String m55(name) => "Vítejte ${name}";

  static String m56(year) => " Před${year} lety";

  static String m57(total) => "Přiřadili jste k objednávce č.${total}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "clearCartAndAddNew":
            MessageLookupByLibrary.simpleMessage("Vymazat košík a přidat nový"),
        "clearConversation":
        ...
        "multipleSellersDetectedAndDisableMultiVendorCheckoutContent":
            MessageLookupByLibrary.simpleMessage(
                "Pokoušíte se přidat do košíku produkt od nového prodejce. Upozorňujeme, že najednou můžete nakupovat pouze u jednoho prodejce."),
