...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m24(message) => "应用程序在请求数据期间出现问题，请联系管理员解决问题： ${message}";

  static String m25(currency, amount) => "使用此付款的最大金额为 ${currency} ${amount}";

  static String m26(size) => "档案大小上限： ${size} MB";

  static String m27(currency, amount) => "使用此付款的最低金额为 ${currency} ${amount}";

  static String m28(minute) => "${minute} 分钟钱";
  ...
  static String m32(itemCount) => "${itemCount} 件商品";
  ...
  static String m38(percent) => "出售${percent}%";
  ...
  static String m46(total) => "${total} 个产品";
  ...
  static String m53(length) => "我们找到 ${length} 个产品";

  static String m54(week) => "周 ${week}";
