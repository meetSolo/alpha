...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m12(country) => "${country} país não é suportado";

  static String m13(currency) => "${currency} não é suportado";
  ...
  static String m17(captcha) => "Digite ${captcha} para confirmar:";
  ...
  static String m33(price) => "Opções no total: ${price}";
  ...
  static String m38(percent) => "Venda ${percent}%";
  ...
  static String m53(length) => "Encontrámos ${length} produtos";
  ...
  static String m57(total) => "Você atribuiu a ordem #${total}";
