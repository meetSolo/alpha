...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m4(author) => "Forfatter: ${author}";

  static String m5(currency) => "Endret valuta til ${currency}";

  static String m6(number) => "${number} tegn igjen";

  static String m7(priceRate, pointRate) => "${priceRate} = ${pointRate} poeng";

  static String m8(count) => "${count} vare";

  static String m9(count) => "${count} varer";

  static String m10(count) => "${count} element";

  static String m11(count) => "${count} elementer";

  static String m12(country) => "Landet ${country} støttes ikke";

  static String m13(currency) => "${currency} støttes ikke";

  static String m14(day) => "${day} dager siden";

  static String m15(total) => "~${total} km";

  static String m16(timeLeft) => "Slutter om ${timeLeft}";

  static String m17(captcha) => "Skriv inn ${captcha} for å bekrefte:";

  static String m18(message) => "Feil: ${message}";

  static String m19(message) => "Feil: ${message}";

  static String m20(time) => "Utløper om ${time}";

  static String m21(total) => ">${total} km";

  static String m22(hour) => "${hour} timer siden";
  ...
  static String m26(size) => "Maksimal filstørrelse: ${size} MB";

  static String m27(currency, amount) =>
      "Minimumsbeløpet for å bruke denne betalingen er ${currency} ${amount}";

  static String m28(minute) => "${minute} minutter siden";

  static String m29(month) => "${month} måneder siden";

  static String m30(store) => "Mer fra ${store}";

  static String m31(number) => "må kjøpes i grupper på ${number}";

  static String m32(itemCount) => "${itemCount} varer";

  static String m33(price) => "Valg totalt: ${price}";

  static String m34(amount) => "Betal ${amount}";

  static String m35(name) => "${name} er lagt til i handlekurven";

  static String m36(total) => "Antall: ${total}";

  static String m37(name) => "Mottok penger fra ${name}";

  static String m38(percent) => "Salg ${percent}%";

  static String m39(keyword) => "Søkeresultater for: \'${keyword}\'";

  static String m40(keyword, count) => "${keyword} (${count} element)";

  static String m41(keyword, count) => "${keyword} (${count} elementer)";

  static String m42(second) => "${second} sekunder siden";

  static String m43(totalCartQuantity) =>
      "Handlekurv, ${totalCartQuantity} varer";

  static String m44(numberOfUnitsSold) => "Solgt: ${numberOfUnitsSold}";

  static String m45(fieldName) => "Feltet ${fieldName} er påkrevd";

  static String m46(total) => "${total} produkter";

  static String m47(name) => "Overfør penger til ${name}";
  ...
  static String m49(date) => "Gyldig til ${date}";

  static String m50(balance) => "Wallet-saldo: ${balance}";

  static String m51(message) => "Advarsel: ${message}";
  ...
  static String m53(length) => "Vi fant ${length} produkter";

  static String m54(week) => "Uke ${week}";

  static String m55(name) => "Velkommen ${name}";

  static String m56(year) => "${year} år siden";

  static String m57(total) => "Du er tildelt bestilling #${total}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "attribute": MessageLookupByLibrary.simpleMessage("Attributt"),
        ...
        "branchChangeWarning": MessageLookupByLibrary.simpleMessage(
            "Beklager, handlekurven vil bli tømt på grunn av endring av region. Vi kontakter deg gjerne dersom du trenger hjelp."),
        ...
        "byAuthor": m4,
        "byBrand": MessageLookupByLibrary.simpleMessage("Etter merke"),
        ...
        "cancelledRequests":
            MessageLookupByLibrary.simpleMessage("Kansellerte forespørsler"),
        ...
        "countryCodeIsRequired":
            MessageLookupByLibrary.simpleMessage("Landskode kreves"),
        ...
        "emailAlreadyInUse":
            MessageLookupByLibrary.simpleMessage("E-post er allerede i bruk!"),
        ...
        "installDigitsPlugin": MessageLookupByLibrary.simpleMessage(
            "Vennligst installer DIGITS: Wordpress Mobile Number Signup and Login plugin"),
        "instantlyClose":
        ...
        "loginToReview": MessageLookupByLibrary.simpleMessage(
            "Vennligst logg inn for å vurdere"),
        "loginToYourAccount":
        ...
        "mobileIsRequired":
            MessageLookupByLibrary.simpleMessage("Mobil er påkrevd"),
        ...
        "multipleSellersDetectedAndDisableMultiVendorCheckoutContent":
            MessageLookupByLibrary.simpleMessage(
                "Du prøver å legge til et produkt fra en ny selger i handlekurven din. Vær oppmerksom på at du kun kan kjøpe fra én selger om gangen."),
        "multipleSellersDetectedAndEnableMultiVendorCheckoutContent":
            MessageLookupByLibrary.simpleMessage(
                "Du prøver å legge til et produkt fra en ny selger i handlekurven din. Vil du fortsette?"),
        ...
        "needHelp": MessageLookupByLibrary.simpleMessage("Trenger hjelp? "),
        ...
        "noConversationDescription": MessageLookupByLibrary.simpleMessage(
            "Den vises når noen begynner å chatte med deg"),
        ...
        "picking": MessageLookupByLibrary.simpleMessage("Venter på levering"),
        "placeMyOrder":
        ...
        "processing": MessageLookupByLibrary.simpleMessage("Behandling..."),
        ...
        "readyToPick":
            MessageLookupByLibrary.simpleMessage("Venter på levering"),
        ...
        "registerErrorSyncAccount": MessageLookupByLibrary.simpleMessage(
            "Kan ikke synkronisere kontoen. Logg på for å fortsette."),
        "registerFailed":
        ...
        "searchEmptyDataMessage": MessageLookupByLibrary.simpleMessage(
            "Oops! Det ser ut til at ingen resultater samsvarer med søkekriteriene dine"),
        "searchForItems":
        ...
        "sendTo": MessageLookupByLibrary.simpleMessage(
            "Kontoen du vil overføre til (e-post)"),
        ...
        "shippingFee": MessageLookupByLibrary.simpleMessage("Fraktgebyr"),
        ...
        "storeLocatorSearchPlaceholder":
            MessageLookupByLibrary.simpleMessage("Skriv inn adresse / by"),
        ...
        "subTitleOrderConfirmed": MessageLookupByLibrary.simpleMessage(
            "Takk for bestillingen. Vi jobber raskt med å behandle bestillingen din. Følg med for en bekreftelses-e-post snart"),
        ...
        "tag": MessageLookupByLibrary.simpleMessage("stikkord"),
        ...
        "unblock": MessageLookupByLibrary.simpleMessage("Fjern blokkering"),
        "unblockUser":
        ...
        "userNotFound":
            MessageLookupByLibrary.simpleMessage("Brukeren ble ikke funnet"),
        ...
        "willNotSendAndReceiveMessage": MessageLookupByLibrary.simpleMessage(
            "Du vil ikke kunne sende og motta meldinger fra denne brukeren."),
        "withdrawAmount": MessageLookupByLibrary.simpleMessage("Ta ut beløp"),
        "withdrawRequest":
            MessageLookupByLibrary.simpleMessage("Trekk tilbake forespørsel"),
        "withdrawal": MessageLookupByLibrary.simpleMessage("Uttak"),
        "womanCollections":
