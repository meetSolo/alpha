...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m5(currency) => "Para birimi ${currency}olarak değiştirildi";

  static String m6(number) => "${number} karakter kaldı";

  static String m7(priceRate, pointRate) => "${priceRate} = ${pointRate} Puan";

  static String m8(count) => "${count} öğe";

  static String m9(count) => "${count} öğe";

  static String m10(count) => "${count} öğe";

  static String m11(count) => "${count} ürün";

  static String m12(country) => "${country} ülke desteklenmiyor";

  static String m13(currency) => "${currency} desteklenmiyor";

  static String m14(day) => "${day} Gün önce";

  static String m15(total) => "~${total} km";

  static String m16(timeLeft) => "Ends in ${timeLeft}";

  static String m17(captcha) => "Onaylamak için ${captcha} girin:";

  static String m18(message) => "Hata: ${message}";

  static String m19(message) => "Hata: ${message}";

  static String m20(time) => " ${time}içinde süresi doluyor";

  static String m21(total) => ">${total} km";

  static String m22(hour) => "${hour} Saat önce";
  ...
  static String m26(size) => "Maksimum dosya boyutu: ${size} MB";

  static String m27(currency, amount) =>
      "Bu ödemeyi kullanmak için minimum tutar ${currency} ${amount}";

  static String m28(minute) => "${minute} Dakika önce";

  static String m29(month) => "${month} ay önce";

  static String m30(store) => " ${store}\'dan daha fazlası";

  static String m31(number) =>
      " ${number}kişilik gruplar halinde satın alınmalıdır";

  static String m32(itemCount) => "${itemCount} ürün";

  static String m33(price) => "Toplam seçenek: ${price}";

  static String m34(amount) => " ${amount}öde";

  static String m35(name) => "${name} başarıyla sepete eklendi";

  static String m36(total) => "Adet: ${total}";

  static String m37(name) => " ${name}\'dan para alındı";

  static String m38(percent) => "% ${percent} İndirim ";

  static String m39(keyword) => "Şunun için arama sonuçları: \'${keyword}\'";

  static String m40(keyword, count) => "${keyword} (${count} öğe)";

  static String m41(keyword, count) => "${keyword} (${count} öğe)";

  static String m42(second) => "${second} Saniye önce";

  static String m43(totalCartQuantity) => "${totalCartQuantity} ürün, Sepette";

  static String m44(numberOfUnitsSold) => "Sold: ${numberOfUnitsSold}";

  static String m45(fieldName) => " ${fieldName} alanı zorunludur";

  static String m46(total) => "${total} ürün";

  static String m47(name) => " ${name}\'a para transferi yapın";
  ...
  static String m49(date) => " ${date}tarihine kadar geçerlidir";

  static String m50(balance) => "Cüzdan bakiyesi: ${balance}";

  static String m51(message) => "Hata: ${message}";
  ...
  static String m53(length) => " \$${length} Ürün Bulundu";

  static String m54(week) => " ${week}haftası";

  static String m55(name) => "Hoş geldiniz ${name}";

  static String m56(year) => "${year} yıl önce";

  static String m57(total) => "#${total}numaralı siparişe atadınız";
