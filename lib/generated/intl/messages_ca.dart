...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m19(message) => "Error: ${message}";
  ...
  static String m26(size) => "Mida màxima del fitxer: ${size} MB";

  static String m27(currency, amount) =>
      "L’import mínim per utilitzar aquest pagament és ${currency} ${amount}";

  static String m28(minute) => "fa ${minute} minuts";

  static String m29(month) => "fa ${month} mesos";

  static String m30(store) => "Més de ${store}";

  static String m31(number) => "s\'ha de comprar en grups de ${number}";

  static String m32(itemCount) => "${itemCount} articles";

  static String m33(price) => "Total d’opcions: ${price}";

  static String m34(amount) => "Pagar ${amount}";

  static String m35(name) => " S\'han afegit${name} al carretó correctament";

  static String m36(total) => "Quantitat: ${total}";

  static String m37(name) => "S\'ha rebut diners de ${name}";

  static String m38(percent) => "Descompte ${percent}%";

  static String m39(keyword) => "Resultats de la cerca per a: \"${keyword}\"";

  static String m40(keyword, count) => "${keyword} (${count} element)";

  static String m41(keyword, count) => "${keyword} (${count} elements)";

  static String m42(second) => "fa ${second} segons";

  static String m43(totalCartQuantity) =>
      "Cistella de compra, ${totalCartQuantity} articles";

  static String m44(numberOfUnitsSold) => "Venuts: ${numberOfUnitsSold}";

  static String m45(fieldName) => "El camp ${fieldName} és obligatori";

  static String m46(total) => "${total} productes";

  static String m47(name) => "Transfereix diners a ${name}";
  ...
  static String m49(date) => "Vàlid fins al ${date}";

  static String m50(balance) => "Saldo de Wallet: ${balance}";

  static String m51(message) => "Advertència: ${message}";
  ...
  static String m53(length) => "Hem trobat ${length} productes";

  static String m54(week) => "Setmana ${week}";

  static String m55(name) => "Benvingut/da ${name}";

  static String m56(year) => "fa ${year} anys";

  static String m57(total) => "T’han assignat la comanda #${total}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "accountApprovalTitle":
            MessageLookupByLibrary.simpleMessage("Sota aprovació"),
        ...
        "addMessage":
            MessageLookupByLibrary.simpleMessage("Afegeix un missatge"),
        "addNew": MessageLookupByLibrary.simpleMessage("Afegir nou"),
        "addNewAddress":
            MessageLookupByLibrary.simpleMessage("Afegeix una adreça nova"),
        ...
        "approvedRequests":
            MessageLookupByLibrary.simpleMessage("Sol·licituds aprovades"),
        ...
        "availabilityProduct":
            MessageLookupByLibrary.simpleMessage("Disponibilitat: "),
        "availablePoints": m2,
        "averageRating":
        ...
        "blockUser":
            MessageLookupByLibrary.simpleMessage("Bloquejar l\'usuari"),
        ...
        "byAppointmentOnly":
            MessageLookupByLibrary.simpleMessage("Només amb cita prèvia"),
        "byAuthor": m4,
        ...
        "cancelledRequests":
            MessageLookupByLibrary.simpleMessage("Sol·licituds cancel·lades"),
        ...
        "confirmPassword":
            MessageLookupByLibrary.simpleMessage("Confirmeu la contrasenya"),
        ...
        "continueShopping":
            MessageLookupByLibrary.simpleMessage("Continuar comprant"),
        "continueToPayment":
        ...
        "deleteConversation":
            MessageLookupByLibrary.simpleMessage("Suprimeix la conversa"),
        ...
        "emptyWishlist":
            MessageLookupByLibrary.simpleMessage("Llista de desitjos buida"),
        ...
        "enterAmount":
            MessageLookupByLibrary.simpleMessage("Introduïu la quantitat"),
        "enterCaptcha": m17,
        ...
        "enterVoucherCode":
            MessageLookupByLibrary.simpleMessage("Introduïu el codi del val"),
        ...
        "informationTable":
            MessageLookupByLibrary.simpleMessage("Taula d\'informació"),
        ...
        "mobileIsRequired":
            MessageLookupByLibrary.simpleMessage("Es requereix un mòbil"),
        ...
        "noStoreNearby":
            MessageLookupByLibrary.simpleMessage("No hi ha botiga a prop!"),
        "noSuggestionSearch":
            MessageLookupByLibrary.simpleMessage("No hi ha suggeriments"),
        ...
        "oneEachRecipient":
            MessageLookupByLibrary.simpleMessage("1 a cada destinatari"),
        ...
        "paymentSettings":
            MessageLookupByLibrary.simpleMessage("Configuració de pagament"),
        "paymentSuccessful":
        ...
        "picking":
            MessageLookupByLibrary.simpleMessage("Esperant el lliurament"),
        "placeMyOrder":
        ...
        "processing":
            MessageLookupByLibrary.simpleMessage("S\'està processant..."),
        ...
        "productOverview":
            MessageLookupByLibrary.simpleMessage("Visió general del producte"),
        "productRating":
        ...
        "selectVoucher":
            MessageLookupByLibrary.simpleMessage("Seleccioneu el val"),
        ...
        "shippingFee":
            MessageLookupByLibrary.simpleMessage("Taxa d\'enviament"),
        "shippingMethod":
        ...
        "storeLocatorSearchPlaceholder":
            MessageLookupByLibrary.simpleMessage("Introduïu l\'adreça/ciutat"),
        "storeLogo":
        ...
        "unblockUser":
            MessageLookupByLibrary.simpleMessage("Desbloqueja l\'usuari"),
        ...
        "uploadImage":
            MessageLookupByLibrary.simpleMessage("Carrega la imatge"),
        ...
        "userNotFound":
            MessageLookupByLibrary.simpleMessage("No es troba l\'usuari"),
        ...
        "withdrawAmount":
            MessageLookupByLibrary.simpleMessage("Retirar quantitat"),
        "withdrawRequest":
            MessageLookupByLibrary.simpleMessage("Retirada de la sol·licitud"),
        ...
        "youHaveNoPost":
            MessageLookupByLibrary.simpleMessage("No tens publicacions"),
        "youHavePoints":
        ...
        "yourOrderIsEmpty":
            MessageLookupByLibrary.simpleMessage("La teva comanda està buida"),
