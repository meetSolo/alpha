...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m18(message) => "错误： ${message}";
  ...
  static String m24(message) => "请求数据时应用出现问题，请联系管理员解决问题： ${message}";

  static String m25(currency, amount) => "使用此付款的最大金额为 ${currency} ${amount}";

  static String m26(size) => "最大文件大小： ${size} MB";

  static String m27(currency, amount) => "使用此付款的最低金额为 ${currency} ${amount}";

  static String m28(minute) => "${minute} 分钟前";

  static String m29(month) => "${month} 个月前";

  static String m30(store) => " ${store}的更多内容";

  static String m31(number) => "必须以 ${number}为一组购买";

  static String m32(itemCount) => "${itemCount} 项";

  static String m33(price) => "选项总数： ${price}";

  static String m34(amount) => "支付 ${amount}";

  static String m35(name) => "${name} 已成功添加到购物车";

  static String m36(total) => "数量： ${total}";

  static String m37(name) => "已收到来自 ${name}的款项";

  static String m38(percent) => "销售额 ${percent}%";

  static String m39(keyword) => "搜索结果：“${keyword}”";

  static String m40(keyword, count) => "${keyword} （${count} 项）";

  static String m41(keyword, count) => "${keyword} （${count} 项）";

  static String m42(second) => "${second} 秒前";

  static String m43(totalCartQuantity) => "购物车， ${totalCartQuantity} 件商品";

  static String m44(numberOfUnitsSold) => "已售出： ${numberOfUnitsSold}";

  static String m45(fieldName) => " ${fieldName} 字段是必需的";

  static String m46(total) => "${total} 个商品";

  static String m47(name) => "转帐至 ${name}";
  ...
  static String m50(balance) => "钱包余额： ${balance}";
  ...
  static String m53(length) => "我们找到了 ${length} 件商品";

  static String m54(week) => "第 ${week} 周";

  static String m55(name) => "欢迎 ${name}";

  static String m56(year) => "${year} 年前";

  static String m57(total) => "您已指定订单 #${total}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "clearCartAndAddNew":
            MessageLookupByLibrary.simpleMessage("清空购物车并添加新品"),
        ...
        "multipleSellersDetectedAndDisableMultiVendorCheckoutContent":
            MessageLookupByLibrary.simpleMessage(
                "您正在尝试将新卖家的产品添加到购物车。请注意，您一次只能从一位卖家处购买。"),
        "multipleSellersDetectedAndEnableMultiVendorCheckoutContent":
            MessageLookupByLibrary.simpleMessage("您正在尝试将新卖家的产品添加到购物车。要继续吗？"),
