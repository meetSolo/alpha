...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m5(currency) => "Mata uang diubah menjadi ${currency}";

  static String m6(number) => "${number} karakter tersisa";

  static String m7(priceRate, pointRate) => "${priceRate} = ${pointRate} Poin";

  static String m8(count) => "${count} barang";
  ...
  static String m12(country) => "${country} negara tidak didukung";

  static String m13(currency) => "${currency} tidak didukung";
  ...
  static String m17(captcha) => "Masukkan ${captcha} untuk mengonfirmasi:";

  static String m18(message) => "Galat: ${message}";

  static String m19(message) => "Kesalahan: ${message}";

  static String m20(time) => "Kedaluwarsa dalam ${time}";
  ...
  static String m26(size) => "Ukuran file maksimum: ${size} MB";
  ...
  static String m30(store) => "Lainnya dari ${store}";

  static String m31(number) => "harus dibeli dalam kelompok ${number}";

  static String m32(itemCount) => "${itemCount} barang";

  static String m33(price) => "Total opsi: ${price}";

  static String m34(amount) => "Bayar ${amount}";

  static String m35(name) => "${name} telah berhasil ditambahkan ke troli";

  static String m36(total) => "Jumlah: ${total}";

  static String m37(name) => "Menerima uang dari ${name}";

  static String m38(percent) => "Diskon ${percent} %";

  static String m39(keyword) => "Hasil penelusuran untuk: \'${keyword}\'";

  static String m40(keyword, count) => "${keyword} (${count} barang)";
  ...
  static String m45(fieldName) => "Bidang ${fieldName} wajib diisi";

  static String m46(total) => "${total} produk";

  static String m47(name) => "Transfer uang ke ${name}";
  ...
  static String m49(date) => "Berlaku sampai ${date}";

  static String m50(balance) => "Saldo dompet: ${balance}";

  static String m51(message) => "Warning: ${message}";
  ...
  static String m53(length) => "Kami menemukan produk ${length}";

  static String m54(week) => "Minggu ${week}";

  static String m55(name) => "Selamat datang ${name}";

  static String m56(year) => "${year} tahun lalu";

  static String m57(total) => "Anda telah menetapkan untuk memesan #${total}";
